...
def train_model(args, train_data):
    ...
    model = Word2Vec(train_data, size=args.size, window=args.window, min_count=args.min_count, workers=args.workers, max_vocab_size=args.vocab_size, negative=args.negative)
    print("saving model")
